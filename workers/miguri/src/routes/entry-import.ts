...
export const MIGURI_IMPORT_CATEGORIES = ['個別ミーグリ', 'リアミ', 'サイン会', 'その他'] as const;
...
export function normalizeImportRecord(input: unknown): NormalizedImportRecord | null {
  ...
  if (appliedTickets === null || wonTickets === null || paidTickets === null) return null;

  const tickets = paidTickets || wonTickets || appliedTickets;
  ...
  if (eventSlug === null || title === null || venue === null) return null;
