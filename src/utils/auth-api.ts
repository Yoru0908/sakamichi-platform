...
export interface RepoWorkItem {
  ...
  ticketCount: number;
  nickname: string;
  messages: Array<{ id: string; speaker: 'me' | 'member' | 'narration'; text: string; imageUrl?: string; imagePairWithPrevious?: boolean; narrationColor?: string }>;
  tags: string[];
  template: string;
...
export interface CreateRepoPayload {
  ...
  ticketCount: number;
  nickname: string;
  messages: Array<{ speaker: string; text: string; imageUrl?: string; imagePairWithPrevious?: boolean; narrationColor?: string }>;
  tags: string[];
  template: string;
  isPublic: boolean;
}
